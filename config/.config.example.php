...
$_ENV['baseUrl'] = 'https://域名/';               //站点地址
$_ENV['muKey'] = 'default';               //用于校验魔改后端请求，可以随意修改，但请保持前后端一致，否则节点不能工作！
...
$_ENV['db_host'] = '';
$_ENV['db_socket'] = '';
$_ENV['db_database'] = 'bb';           //数据库名
$_ENV['db_username'] = 'bb';              //数据库用户名
$_ENV['db_password'] = 'BnAyHWBSn3xeZyZD';           //用户名对应的密码
#高级
...
$_ENV['min_port'] = 40000;                     //用户端口池最小值，如果该数值为0则用户在注册的时候不会被分配多用户端口，适合纯V2Ray/Trojan机场
...
//已注册用户设置---------------------------------------------------------------------------------------
#基础
$_ENV['checkinMin'] = 1000;            //用户签到最少流量 单位MB
$_ENV['checkinMax'] = 5000;           //用户签到最多流量

$_ENV['auto_clean_uncheck_days'] = -1;           //自动清理多少天没签到的0级用户，小于等于0时关闭
$_ENV['auto_clean_unused_days'] = 90;           //自动清理多少天没使用的0级用户，小于等于0时关闭
...
$_ENV['subscribeLog_keep_days'] = 3;                            //订阅记录保留天数
...
#iOS账户显示
$_ENV['display_ios_class'] = 3;        //至少等级为多少的用户可以看见，小于0时关闭此功能
...
$_ENV['pwdMethod'] = 'sha256';               //密码加密 可选 md5, sha256, bcrypt, argon2i, argon2id（argon2i需要至少php7.2）
